    ...
    ;
            ...
            for(var i =0; i < map_modes.length; i++){
              ...
              if(control[0]){
                if(mode_type == map_modes[i]){
                  jQuery("#button-" + map_modes[i] + "-icon").attr("src","../images/assets/" + map_modes[i] + "-icon-down.gif");
                  control[0].activate();
                }else{
                  jQuery("#button-" + map_modes[i] + "-icon").attr("src","../images/assets/" + map_modes[i] + "-icon-up.gif");
      ...
      function toggle_soil_layer(){
        ...
        if(show_soil_layers){
          ...
          jQuery("#button-soil-icon").attr("src","../images/assets/soil-button-down.gif");
        }else{
          mupolygon_layer[0].setVisibility(false);
          jQuery("#button-soil-icon").attr("src","../images/assets/soil-button-up.gif");
        } 
